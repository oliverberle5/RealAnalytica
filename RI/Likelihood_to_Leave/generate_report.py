...
def main():
    ...
    with PdfPages(out_path) as pdf:
        ...
        rows = [
            ("Prediction horizon", "3 months (not 12) — unlocks 94.4% of rows vs. 77.9%, matches “who's a flight risk right now.”"),
            ...
            ("Label cleanup", "459 rows recoded from “left” to “stayed” across 23 confirmed rebrand/M&A/mass-mover office\ntransitions (≥5 agents, same origin/destination, same quarter) — corporate events, not\nvoluntary departures."),
